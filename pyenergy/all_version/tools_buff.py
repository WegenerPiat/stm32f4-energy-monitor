...
def continuous(serial, mpoints, delay=0.1):
	...
	with open(nameFile,"a") as fichier :
	    fichier.write("time, energy_{0}, avg_power_{0}, ins_voltage_{0}, avg_voltage_{0},".format(mp))
	    fichier.write("\n")
        print "time, energy_{0}, avg_power_{0}, ins_voltage_{0}, avg_voltage_{0},".format(mp),	# 
    print ""
    ...
    try:
        while True:
			...
			fichier.write(str(m.time))
                    print m.time,
		with open(nameFile,"a") as fichier :
		    fichier.write(", {}, {}, {}, {},".format(m.energy, m.avg_power, m.test_tension, m.avg_voltage))
		    fichier.write("\n")
                print ", {}, {}, {}, {},".format(m.energy, m.avg_power, m.test_tension, m.avg_voltage),
            print ""
            #sleep(delay)
