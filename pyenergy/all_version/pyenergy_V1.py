...
class MeasurementSet(object):
    ...
    def _op_self(self, other, fn):
        params = ["energy", "time", "peak_power", "peak_voltage", "peak_current",	# avg_current
    ...
    def __repr__(self):
        keys = ["energy", "time", "peak_power", "peak_voltage", "peak_current", "n_samples", "avg_voltage", "test_tension", "avg_power"]	#avg_current
...
class Measurement(object):
    ...
    def __init__(self, energy=0, time=0, peak_power=0, peak_voltage=0, peak_current=0,	# avg_current
