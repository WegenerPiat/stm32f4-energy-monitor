...
def continuous(serial, mpoints, delay=0.1):
    ...
    for mp in mpoints:
        em.enableMeasurementPoint(mp)
        em.start(mp)
	nameFile=em.testWriteFile(mp)

	with open(nameFile,"a") as fichier :
	    fichier.write("Point de mesure numéro {0} \n".format(mp))
	    fichier.write("time_1, donnée_1 ; time_2, donnée_2 ; time_3, donnée_3 ; time_4, donnée_4 ;")
	    fichier.write("\n")
        print "Point de mesure numéro {0} \n".format(mp),
	print "time_1, donnée_1 ; time_2, donnée_2 ; time_3, donnée_3 ; time_4, donnée_4 ;"
    print ""
    ...
    try:
        while True:
            ...
            for mp in mpoints:
                ...
                if first:
		#    with open(nameFile,"a") as fichier :
		#	fichier.write(str(m.time))
                #    print m.time,
		    with open(nameFile,"a") as fichier :
		        fichier.write("{}, {}, {}, {}, {}, {}, {}, {}".format(m.elapsed_time1, m.donnee1, m.elapsed_time2, m.donnee2, m.elapsed_time3, m.donnee3, m.elapsed_time4, m.donnee4))
		        fichier.write("\n")
                print "{}, {}, {}, {}, {}, {}, {}, {}".format(m.elapsed_time1, m.donnee1, m.elapsed_time2, m.donnee2, m.elapsed_time3, m.donnee3, m.elapsed_time4, m.donnee4),
            print ""
            #sleep(delay)
    ...
    while True:
        ...
        if c == 'a' or c == "e":
            ...
            if platform == "beaglebone":
                ...
                mp  = choice("Measurement point connected to {}".format(platform), ["1", "2", "3", "4" ], initial=default_mp)
                res = choice("Shunt resistor used: ", ["0.04", "0.2"], initial = default_res)
